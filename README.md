...
Please continue to abide by the conventions and rules of good conduct in GeoFS, and remember that no other players can see your weapon systems. 
...
- Upcoming developments: sounds [done]
...
- Upcoming developments: sounds [done], better tracers, impact recognition on aircraft.
...
- Developments: lock and target acquisition sounds [done]; make nearby aircraft lock faster than distant ones; prioritise selection for nearby aircraft. 
...
- Upcoming developments: sounds [done]; missile model visualisation; hit/miss based on behaviour; multiplayer?.
